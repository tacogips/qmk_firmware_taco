...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Enter| BS |  Del | Shift|||||||| GUI  | Ctrl |Space |||||||| Alt  | Shift | Space|||||||| Ctrl | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
    ...
    KC_ENT,  KC_BSPC,  KC_DEL,  KC_LSFT,  KC_LGUI, KC_LCTL,KC_SPC,        KC_LALT, KC_LSFT, KC_SPC, KC_LCTL,     KC_LEFT, KC_DOWN,  KC_RGHT \
  ),
